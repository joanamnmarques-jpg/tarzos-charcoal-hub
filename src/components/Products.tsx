...
const products = [
  {
    id: 1,
    name: "Carvão Premium",
    subtitle: "Madeira de Marabú",
    description: "Carvão de madeira de marabú de origem cubana, 100% natural. Combustão lenta e uniforme, ideal para grelhados de alta qualidade.",
