      ...
      <DialogContent className="max-w-3xl max-h-[90vh]">
        ...
        <ScrollArea className="h-[70vh] pr-4">
          <div className="space-y-6 text-muted-foreground">
            <section>
              <h3 className="text-foreground font-semibold mb-2">1. Introdução</h3>
              <p>
            ...
            <section>
              <h3 className="text-foreground font-semibold mb-2">2. Dados Pessoais Recolhidos</h3>
              <p className="mb-2">
            ...
            <section>
              <h3 className="text-foreground font-semibold mb-2">3. Finalidade do Tratamento dos Dados</h3>
            ...
            <section>
              <h3 className="text-foreground font-semibold mb-2">4. Partilha de Dados com Terceiros</h3>
              <p className="mb-2">
            ...
            <section>
              <h3 className="text-foreground font-semibold mb-2">5. Conservação dos Dados</h3>
              <p>
            ...
            <section>
              <h3 className="text-foreground font-semibold mb-2">6. Segurança dos Dados</h3>
              <p>
            ...
            <section>
              <h3 className="text-foreground font-semibold mb-2">7. Direitos dos Titulares dos Dados</h3>
            ...
            <section>
              <h3 className="text-foreground font-semibold mb-2">8. Cookies</h3>
              <p>
            ...
            <section>
              <h3 className="text-foreground font-semibold mb-2">9. Alterações à Política de Privacidade</h3>
              <p>
            ...
            <section>
              <h3 className="text-foreground font-semibold mb-2">10. Contactos</h3>
              <p>
