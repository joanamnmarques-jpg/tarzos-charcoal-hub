...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-1/4 right-10 w-96 h-96 bg-fire-ember/20 rounded-full blur-[120px] animate-pulse-slow" />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 bg-secondary/50 backdrop-blur-sm border border-border rounded-full px-4 py-2 mb-8 animate-fade-in">
            ...
            <span className="text-sm text-muted-foreground">Fornecedor Premium de Carvão para Restaurantes</span>
          </div>
          ...
          <h1 className="font-display text-6xl md:text-8xl lg:text-9xl text-foreground mb-6 leading-none animate-fade-in" style={{ animationDelay: "0.1s" }}>
            O FOGO QUE
            <span className="block text-gradient-fire">ELEVA O SABOR</span>
          </h1>
